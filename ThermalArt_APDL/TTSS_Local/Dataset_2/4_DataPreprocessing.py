...
def get_DeepONet_data(train_data, Power, HTC, Die_xy, Die_z, t_Diel, t_Insulator, K_Diel, TTSS_value):
...
def main():
    ...
    directory = './DeepONetData_20210215_v01/One_tile_3D_data'
    ...
    for folder in file_directories:
        ...
        txt_name = "commands_TTSS_template_4.txt"
        ...
        u, y, s = get_DeepONet_data(filtered_data, PowerTotal, HTC, Die_xy, Die_z, t_Diel, t_Insulator, K_Diel, TTSS_value)
