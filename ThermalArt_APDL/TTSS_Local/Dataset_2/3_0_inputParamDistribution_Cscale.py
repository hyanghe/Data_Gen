...
def main():
    ...
    directory = './SolverData_Cscale_v01'

    save_data_path = './Data_20210217_v01_cscale_v01/'
    ...
    arg_idx = np.argsort(c_scale_lst)
    ax.plot(c_scale_lst[arg_idx], TTSS_lst[arg_idx], color='b', marker='*')
    plt.legend(['Effect of Cscale on TTSS'])
    plt.xlabel('C_scale')
    plt.ylabel('TTSS (s)')
