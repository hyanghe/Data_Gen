...
def main():
    ...
    for folder in file_directories:
        ...
        decay_curve_data_txt_name = "decay_curve_diag.txt"
        ...
        decay_curve_data_file_name_updated = os.path.dirname(target_folder_name) + "/decay_curve_filtered_diag.txt"
        ...
        decay_curve_far_data_txt_name = "decay_curve_far_diag.txt"
        decay_curve_far_data_file_name = source_dir + decay_curve_far_data_txt_name
        decay_curve_far_data = np.loadtxt(decay_curve_far_data_file_name, skiprows=19)
        ...
        np.save(os.path.dirname(target_folder_name) + "/decay_curve_full_range_data_diag", decay_curve_full_range_data)
