...
txt_name = "\commands_tile_heating_HTC_BC_area_effects_Haiyang.txt"
...
def create_input_files(params):
    for param in params:
        ...
        # target_folder_name = dest_fpath + f"Q_{Power}_HTC_{HTC}_xy_{Die_xy}_z_{Die_z}_tDiel_{t_Diel}_tIns_{t_Insulator}_Kd_{K_Diel}\\"
        ...
        line_shift = 3
        lines[10-line_shift] = lines[10-line_shift][:13] + f'{Die_xy}' + lines[10-line_shift][18:] ## Die x length
        lines[11-line_shift] = lines[11-line_shift][:13] + f'{Die_xy}' + lines[11-line_shift][18:] ## Die y length
        lines[12-line_shift] = lines[12-line_shift][:13] + f'{Die_z}\n' ## Die z length
        lines[13-line_shift] = lines[13-line_shift][:17] + f'{t_Insulator}\n' ## Insulator layer thickness
        lines[14-line_shift] = lines[14-line_shift][:12] + f'{t_Diel}\n' ## Dielectric layer thickness
        lines[15-line_shift] = lines[15-line_shift][:10] + f'{tile_size}\n'  ## tile size
        lines[33-line_shift] = lines[33-line_shift][:8] + f'{K_Diel}\n' ## Dielectric layer K
        lines[49-line_shift] = lines[49-line_shift][:8] + f'{HTC}\n' ## top HTC
        lines[51-line_shift] = lines[51-line_shift][:8] + f'{HTC}\n'## bottom HTC
        lines[55-line_shift] = lines[55-line_shift][:11] + f'{Power}\n' ## power
